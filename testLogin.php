    ...
    <div class="">
        ...
        <div class="container">
            ...
            //userPassword == patientPassword -->
                    <!-- //userLogin== email -->
                    <div class="LoginForm">
                        <form action="testCheckLogin.php" method="post">
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="patientPassword" id="patientPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z).{8,}" title="Must contain a minimum of one uppercase and lowercase letter and at least 8 or more characters" required>
                        ...
                        <!-- <p><a href="testRegister.php">Register</a></p>
                        <p><a href="testIndex.php">Not Allowed!</a></p> -->
                    </div><br><br>
