...
<body>
    <div class="">
        ...
        <main>
            ...
            <form action="testCreatePatientSQL.php" method="POST" >
                ...
                <div class="createStaffForm">
                    <input type="text" name="address_" placeholder="address_"><br>
                </div>
                ...
                <div class="createStaffForm">
                    <input type="text" name="patientPassword" placeholder="patientPassword"><br>
                </div>
