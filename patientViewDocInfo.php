...
<body>
    ...
    <div class="">
        ...
        <div class="viewStaffInfoTitle">
            <h1>View Staff info:</h1><br><br>
        </div>

        <!-- check for search submission -->

        <div class="viewStaffInfo">
            <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) { //mysqli_fetch_assoc // fetches next available row within our object 
                    ...
                    echo "Staff phone number: " . $row["phoneNumber"] . "<br>";
                    echo "Staff role: " . $row["staffRole"] . "<br>" . "<br>" . "<br>";
                };
            } else {
                echo "No user found";
            }
